...
import RelicCodexModal from "./RelicCodexModal";
      ...
      <div className="bg-dark-bg/40 border border-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-md relative shadow-xl min-h-[340px] flex flex-col justify-between">
        ...
        <div className="flex flex-row justify-between items-center mb-12 relative z-10 gap-4">
          ...
          <div className="relative flex flex-col gap-1 min-w-fit">
            ...
            {/* ⚔️ THE HEADER RAY - opacity-40 and z-[-10] to make it transparent and below all content */}
            ...
            <div className="flex items-baseline gap-2.5">
              ...
              {/* ⚔️ Brightened the total count text */}
        ...
        {/* --- MEDALS GRID --- */}
        <div className="grid grid-cols-3 md:grid-cols-5 gap-x-4 gap-y-12 relative z-10 mt-auto">
          {medals.map((vm, index) => {
              ...
              return (
                <div 
                  key={index}
                  // ⚔️ Clicking the relic directly opens the Codex Modal
                  onClick={() => setIsCodexOpen(true)}
                ...
                >
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none z-0">
                     <img 
                       src={rayImageSrc}
                       alt=""
                       // ⚔️ Scaled to 2.0 to blast outwards from the bigger icon
                  ...
                  {/* ⚔️ DYNAMIC RELIC ICON - Changed to 120% to break out of the grid cell bounds */}
          ...
          {emptySlots > 0 && [...Array(emptySlots)].map((_, i) => (
            <div 
              ...
              onClick={() => setIsCodexOpen(true)}
            >
              {/* ⚔️ Dynamic Empty Slot Box - Tweaked to 70% so it doesn't look tiny next to the massive 120% icons */}
