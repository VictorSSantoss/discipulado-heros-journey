...
export const ESTRUTURAS = {
  ...
  IMS: { label: "IMS", fullName: "Mídia e Comunicação", color: "#0ea5e9", secondary: "#38bdf8" },
  LOUVOR: { label: "Louvor", fullName: "Louvor e adoração", color: "#8b5cf6", secondary: "#a78bfa" },
  NEWBREED: { label: "New Breed", fullName: "New Breed", color: "#10b981", secondary: "#34d399" },
  INTERCESSAO: { label: "Intercessão", fullName: "Intercessão", color: "#10b981", secondary: "#34d399" },
  GOE: { label: "GOE", fullName: "GOE", color: "#10b981", secondary: "#34d399" },
...
export const LOVE_LANGUAGES = [
  { name: 'Presentes', key: 'presentes', colors: ['#fbbf24', '#d97706'] },        
  { name: 'Toque Físico', key: 'toque', colors: ['#fb7185', '#e11d48'] },    
  { name: 'Tempo de Qual.', key: 'tempo', colors: ['#c084fc', '#6d28d9'] },
  { name: 'Afirmação', key: 'palavras', colors: ['#22d3ee', '#0284c7'] }, 
  { name: 'Serviço', key: 'servico', colors: ['#34d399', '#059669'] },         
] as const;
